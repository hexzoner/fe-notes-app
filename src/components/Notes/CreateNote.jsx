        ...
        <div className="modal-box h-[500px]">
          ...
          <form className="flex flex-col items-center justify-center gap-2" onSubmit={handleSubmit}>
            <label className="input input-bordered flex items-center w-full">
              <input className="grow" placeholder="Title" name="title" value={title} onChange={handleChange} />
            </label>
            <label className="input input-bordered flex items-center w-full">
              <input className="grow" placeholder="Author" name="author" value={author} onChange={handleChange} />
            </label>
            <label className="input input-bordered flex items-center w-full">
              <input className="grow" placeholder="Image URL" name="image" value={image} onChange={handleChange} />
            </label>
            <div className="label w-full">
              <textarea cols={80} rows={10} className="textarea textarea-bordered h-24" placeholder="Content" name="content" value={content} onChange={handleChange}></textarea>
            </div>
